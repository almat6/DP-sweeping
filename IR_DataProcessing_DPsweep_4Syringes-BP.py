...
def CalConversion(x:float, y:float)->float:
    '''
    Explanation: This function is used to calcute the conversion of monomer:
...
StockCon_RAFTAgent = 0.348 #float(input('\033[1;31mPlease input the initial concentration of your RaftAgent (M):>> \033[0m'))
StockCon_Initiator = 0.02
StockCon_Monomer_inRA = 0.2 
...
for i in range(No_steps+1):
    ...
    MonCon_inRA = FRRaftAgent *  StockCon_Monomer_inRA / Flowrate
    Actual_Mon_Con = Pro_Monomer - MonCon_inRA
    FRMonomer = (Actual_Mon_Con) * Flowrate / StockCon_Monomer
    FRSolvent = Flowrate - FRMonomer - FRRaftAgent - FRInitiator
